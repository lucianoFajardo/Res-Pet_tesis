...
class data_Lost_Pet {
  ...
  factory data_Lost_Pet.fromMap(Map<String, dynamic> map) {
    return data_Lost_Pet(
      id_pet_adoption: map['uuid'],
      ...
      celphoneUser: map['celphoneUser'],
      id_user_created: map['id_user_created'],
      modificated_at: map['modificated_at'] ?? 'fecha no modificada',
    );
  }
}